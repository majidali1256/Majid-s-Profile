...
const TimelineItem = ({ year, title, subtitle, desc, color }: { year: string, title: string, subtitle: string, desc?: string, color: string }) => {
...
const ProjectCard = ({ color, title, description, tags }: { color: string, title: string, description: string, tags: string[] }) => (
  <motion.div 
    variants={fadeInUp}
    whileHover={{ y: -10 }}
